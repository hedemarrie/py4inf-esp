...
\afterverb
%
El indicador {\tt >>>} es la manera en que el int\'erprete de Python le pregunta a usted ``?`Qu\'e quiere que haga despu\'es?''. Python est\'a listo para tener una conversaci\'on con usted. Lo que tiene que saber is c\'omo hablar en el lenguage de Python y usted podr\'a sostener una conversaci\'on.
...
\beforeverb
\begin{verbatim}
>>> Yo vengo en plan de paz, por favor lleveme a su autoridad 
  File "<stdin>", line 1
    Yo vengo en plan de paz, por favor lleveme a su autoridad
         ^
