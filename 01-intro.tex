...
los trata como una secuencia ordenada de oraciones y es capaz de recuperar datos creados en frases escritas desde el principio. Estamos escribiendo nuestro primer p\'arrafo sencill con cuatro oraciones en un orden l\'ogico y significativo.
...
Si usted tiene un sistema Windows, a menudo estos programas ejecutables de lenguage de m\'aquina tienen un sufijo o extensi\'on ``.exe'' o ``.dll'' que significa ``ejecutable'' y ``biblioteca dinamicamente cargable'', respectivamente. En Linux y Macintosh no hay sufijo que indentifique un archivo como ejecutable.

Si usted abriera archivo ejecutable en un editor de texto, ver\'ia algo completamente ilegible:
